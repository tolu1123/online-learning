...
export function RequestDetailPage() {
  ...
  const handleMarkCorrect = (solutionId) => {
    setSolutions(
      solutions.map((sol) => ({
        ...sol,
        isCorrect: sol.id === solutionId,
      })),
    )
  }
                ...
                <CardContent className="pt-6">
                  ...
                  {!solution.isCorrect && (
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => handleMarkCorrect(solution.id)}
            ...
            <CardContent>
              <form onSubmit={handleSubmitSolution} className="space-y-4">
                <textarea
                  ...
                  className="flex min-h-40 w-full rounded-md border border-gray-200 bg-white px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950"
